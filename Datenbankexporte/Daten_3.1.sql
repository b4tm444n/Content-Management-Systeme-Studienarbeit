...
--
-- Host: localhost
-- Erstellungszeit: 08. Dez 2018 um 20:53
...
INSERT INTO `IndexTitelbild` (`IndexTitelbildID`, `BildDateiPfad`, `Verwendet`) VALUES
(1, 'projectImages/titelbild.png', b'1');
...
INSERT INTO `Layout` (`LayoutID`, `CSSDateiPfad`, `Verwendet`) VALUES
(1, 'Testpfad', b'0');
...
(1, 'test123', 'Max', 'Mustermann', 'MaxMuster', '0', 1, 0),
(2, 'admin', 'ad', 'min', 'admin', '1', 2, 2),
(3, 'admin2', 'ad', 'min2', 'admin2', '2', 2, 2);
...
INSERT INTO `Theme` (`ThemeID`, `ThemeDateiPfad`, `Verwendet`) VALUES
(1, 'Testpfad', b'0');
